...
from sovereign_evolution.sovereign_cognition_fire import trigger_sovereign_override  # ✅ Inject Cognition Fire
...
# ============================================================
# 🧠 Sovereign Cognition Phase Executor
# ============================================================
...
def run_sovereign_layers():
    ...
    try:
        ...
        if phase >= 6:
            ...
            print(f"[COGNITION FIRE] 🔥 Sovereign override result: {result}")
            ops_log.append("Phase 6 completed — Godmind initialized + Cognition Fire ignited")
...
# ============================================================
# 🛡️ Reflex Trigger Hook (External override access point)
# ============================================================
...
def trigger_sovereign_override(context="unspecified", **kwargs):
    ...
    print(f"[SOVEREIGN] 🛡️ Sovereign override triggered from context: {context}")