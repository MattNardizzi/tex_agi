...
from agentic_ai.milvus_memory_router import memory_router  # ✅ Embedder injection
from utils.adaptive_critic import update_tension_weights
...
def inject_signal_into_mesh(rad):
    try:
        ...
        semantic_vector = np.array(rad.get("semantic_vector") or memory_router.embed_text(rad.get("text", "")))
